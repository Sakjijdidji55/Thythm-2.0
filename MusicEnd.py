...
class MusicEnd:
    def __init__(self,song:Music,score: float,total: float,perfect: int,good: int,miss: int):
        '''
        :param score: 得分
        :param total: 总分
        :param perfect: 完美数
    ...
    def draw(self,window: pygame.Surface):
        ...
        window.blit(miss_img,(WIDTH//2 + WIDTH//4 - miss_img.get_width()//2, HEIGHT//2 + 280/1536*WIDTH - HEIGHT//8))
        window.blit(miss, (WIDTH//2 + WIDTH//4 - miss.get_width()//2, HEIGHT//2 + 305/1536*WIDTH - HEIGHT//8))
        
        window.blit(self.song.cover,(WIDTH//16,HEIGHT//4 + HEIGHT // 8)) # 绘制歌曲封面
