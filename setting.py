...
class MUSICSETTING:
    ...
    def draw(self,window: pygame.Surface):
        ...
        window.blit(voulme_value,(self.max + 90/1536*WIDTH,self.y + 175/1536*WIDTH)) # 音量
        window.blit(self.long,(self.x + 200/1536*WIDTH,self.y + 180/1536*WIDTH)) # 大滑块
        ...
        if self.effect_state:
            ...
            window.blit(self.v_img,(self.x + 695/1536*WIDTH,self.y + 380/1536*WIDTH)) # 音效
        ...
        window.blit(self.ve_img,(self.x + 305/1536*WIDTH,self.y + 575/1536*WIDTH)) # 文字+覆盖原本的图片+框
    ...
    def is_check_set(self,event):
        ...
        if event.type == pygame.MOUSEMOTION:
            ...
            if self.small_state == True:
                ...
                self.volume = (small_x - self.x - 200 / 1536 * WIDTH) / (560 / 1536 * WIDTH)
                if small_x > self.max:
                    small_x = self.max
                    self.volume = 1
